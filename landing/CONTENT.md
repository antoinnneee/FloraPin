...
2. **🗺️ Carte des fleurs** — « Toutes vos trouvailles réunies sur une carte
   interactive, regroupées intelligemment et filtrables. »
3. **🖼️ Galerie & détail** — « Retrouvez chaque fleur avec sa photo, ses notes
   et sa mini-carte. »
...
- **Texte** : « Un coin rare que vous voulez garder pour vous ? À chaque partage,
