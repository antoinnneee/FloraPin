...
// Tous les rôles Material 3 sont mappés (au-delà de primary/secondary/tertiary)
// pour que la DA botanique habille fonds, surfaces, contours et conteneurs —
// pas seulement les boutons. Couleurs définies dans Color.kt.
