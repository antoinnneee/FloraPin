...
object BadgeCatalog {
    ...
    val COUNTRIES: List<BadgeDef> = listOf(
        BadgeDef(BadgeCalculator.EXPLORATEUR, "🧭", "Explorateur", BadgeCalculator.EXPLORATEUR_TIERS.toList(), BadgeSource.COLLECTION,
            "Photographiez des fleurs dans différentes régions, quel que soit le pays."),
        BadgeDef(BadgeCalculator.FRANCE, "🇫🇷", "France", BadgeCalculator.FRANCE_TIERS.toList(), BadgeSource.COLLECTION,
            "Photographiez des fleurs dans différentes régions françaises."),
        BadgeDef(BadgeCalculator.BELGIQUE, "🇧🇪", "Belgique", BadgeCalculator.BELGIUM_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les trois Régions belges."),
        BadgeDef(BadgeCalculator.SUISSE, "🇨🇭", "Suisse", BadgeCalculator.SWITZERLAND_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les 26 cantons suisses."),
        BadgeDef(BadgeCalculator.ANGLETERRE, "🇬🇧", "Angleterre", BadgeCalculator.ENGLAND_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les neuf régions anglaises."),
        BadgeDef(BadgeCalculator.IRLANDE, "🇮🇪", "Irlande", BadgeCalculator.IRELAND_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les quatre provinces irlandaises."),
        BadgeDef(BadgeCalculator.ESPAGNE, "🇪🇸", "Espagne", BadgeCalculator.SPAIN_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les 19 communautés ou villes autonomes espagnoles."),
        BadgeDef(BadgeCalculator.ITALIE, "🇮🇹", "Italie", BadgeCalculator.ITALY_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les 20 régions italiennes."),
        BadgeDef(BadgeCalculator.JAPON, "🇯🇵", "Japon", BadgeCalculator.JAPAN_TIERS.toList(), BadgeSource.COLLECTION,
            "Explorez progressivement les huit grandes régions japonaises."),
    )
